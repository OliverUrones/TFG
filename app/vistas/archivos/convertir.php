...
<?php } ?>
        ...
        <div class="form-group dropzone" options="dzOptions" callbacks="dzCallbacks" methods="dzMethods" ng-dropzone ng-model="convertir.archivos">
